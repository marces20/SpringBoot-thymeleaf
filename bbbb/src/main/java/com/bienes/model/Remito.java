...
public class Remito {
	...
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE,generator = "remitos_seq_gen")
	@SequenceGenerator(name = "remitos_seq_gen", sequenceName = "remitos_id_seq",allocationSize=1)
	private Integer id;
